...
const CheckoutForm = () => {
  ...
  return (
    <div className='max-w-[1110px] mx-auto'>
      <div className="pl-[1.5rem] lg:pl-0 mb-[1.5rem] lg:mt-[79px]">
        <Link to={`/${category}/${productId}`}
          className='text-second-black opacity-50 text-[.935rem] leading-[25px]'>
          Go Back
        </Link>
      </div>
      <section className='max-w-[662px] lg:max-w-[1110px] px-[1.5rem] lg:mb-[141px] xl:px-0 lg:gap-[30px] w-full mx-auto  lg:flex mt-4 md:mt-12'>
