		...
		<div className="bg-new-product-mobile md:bg-new-product-tablet lg:bg-new-product-desktop bg-almost-white bg-no-repeat bg-cover min-h-[100vh] 
			...
			<div className="max-w-[1110px] mx-auto">
				...
				lg:pl-[3rem] 1110:pl-0">
					...
					<Link to={to} className="inline-block bg-reddish-orange hover:bg-reddish-hover text-white text-[.813rem] tracking-[1px] uppercase font-bold py-[1rem] px-[2rem]">
						See Product
					</Link>
				</div>
			</div>
